        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen gap-16">
          ...
          <div className={`lg:w-3/5 text-white space-y-8 transition-all duration-1000 ${isVisible ? 'animate-slide-in-left opacity-100' : 'opacity-0'}`}>
            ...
            animationDelay: '0.9s'
              ...
              <Button size="lg" variant="outline" onClick={() => scrollToSection('contact')} className="bg-gradient-to-r bg-gradient-to-r to-orange-500 text-white hover:shadow-lg transition-all duration-500 group px-8 py-3 rounded-full font-semibold text-base">
